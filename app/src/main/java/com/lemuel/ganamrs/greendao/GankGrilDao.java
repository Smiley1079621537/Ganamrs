...
public class GankGrilDao extends AbstractDao<GankGril, Void> {
    ...
    /**
     * Properties of entity GankGril.<br/>
    ...
    public GankGrilDao(DaoConfig config) {
        super(config);
    }
    
    public GankGrilDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GANK_GRIL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GankGril entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GankGril entity) {
        stmt.clearBindings();
    ...
    @Override
    public GankGril readEntity(Cursor cursor, int offset) {
        GankGril entity = new GankGril( //
    ...
    @Override
    public void readEntity(Cursor cursor, GankGril entity, int offset) {
